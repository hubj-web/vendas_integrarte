...
import { FileSpreadsheet, FileText, Download, Filter, Users, ClipboardList } from "lucide-react";
...
export default function Exports() {
  ...
  const isLoadingOrders = ordersExcel.isPending || ordersPdf.isPending;
      ...
      <div className="p-6 max-w-4xl mx-auto space-y-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Exporte pedidos e clientes em Excel (.xlsx) ou PDF para análise e impressão.
          </p>
        </div>
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription>
                  Filtre por período, status e forma de pagamento antes de exportar.
                </CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent className="space-y-5">
            ...
            <p className="text-xs text-muted-foreground">
              O Excel inclui todas as colunas detalhadas. O PDF é ideal para impressão e compartilhamento.
            </p>
          </CardContent>
        </Card>
